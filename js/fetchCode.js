...
///////
function menuMusica() {
	var Ctopo = "<li class='btn-primary'><a href='Menu.html'>Menu</a></li><li class='active'><a>Music</a></li>";
	document.getElementById('topo').innerHTML = Ctopo;
...
///////
function menuMapa() {
	var Ctopo = "<li class='btn-primary'><a href='Menu.html'>Menu</a></li><li class='active'><a>Cantos do Bar</a></li>";
	document.getElementById('topo').innerHTML = Ctopo;
...
///////
function menuUser() {
	var Ctopo = "<li class='btn-primary'><a href='Menu.html'>Menu</a></li><li class='active'><a>Conta de utilizador</a></li>";
	document.getElementById('topo').innerHTML = Ctopo;
...
///////
function menuMenu() {
	var Ctopo = "<li class='active'><a href='Menu.html'>Menu</a></li>";
	document.getElementById('topo').innerHTML = Ctopo;
	var txt = "<div align='center'  class='list-group'><a onclick='menuConsumo()' class='list-group-item'>Consumir</a>";
	txt += "<a href='cantos.html' class='list-group-item'>Lugares</a><a onclick='JStester()' class='list-group-item'>Música</a>";
	txt += "<a href='compras.html' class='list-group-item'>Ver consumo</a><a href='user.html' class='list-group-item'>Ver detalhes</a></div>";
	document.getElementById('jumbo').innerHTML = txt;
}
